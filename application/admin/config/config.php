...
/*
|--------------------------------------------------------------------------
| Some types of usrs and hotels
|--------------------------------------------------------------------------
*/
$config['users'] = array("admin"=>"administrator", "editor"=>"editor", "user"=>"utilizator");
$config['currencies'] = array("LEI"=>"Lei", "EURO"=>"Euro", "USD"=>"USD", "GBP"=>"GBP");

$pagination = array();
$pagination['base_url'] = "";
$pagination['total_rows'] = 0;
$pagination['per_page'] = 50;
$pagination['cur_tag_open'] = '<li class="nav_selected">';

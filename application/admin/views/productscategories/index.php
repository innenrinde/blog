			...
			<div class="panel panel-default">
				<div class="panel-heading" style="height: 50px;">
					<div style="float: right;">
						<a href="<?=base_url(array("admin.php", "productscategories", "order"));?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-sort"></span> Setează ordinea</a>
						<a href="<?=base_url(array("admin.php", "productscategories", "add"));?>" class="btn btn-info btn-sm">+ Adaugă o categorie</a>
					</div>
					<?=$title?>
				</div>
				<!-- /.panel-heading -->
...
function delete_record_confirm() {
	...
	$.ajax({
        url: "<?=base_url(array("admin.php", "productscategories", "delete"));?>",
        type :"POST",
        data: {

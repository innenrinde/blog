	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				redirect('/admin.php/auth/login', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
		...
		$this->load->view('templates/header_simple', $this->data);

			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label>Nume</label>
						<input class="form-control" name="judet" id="judet" value="<?=htmlspecialchars($item['judet'])?>">
					</div>
					<div class="form-group">
					...
					<div class="panel panel-default">
						...
						<table class="">
							<tr>
								...
								<?php if(strlen($item['image_file']) > 0) { ?>
									<img src="<?=$this->config->item('base_url')?>files/counties/thumb/<?=$item['image_file']?>" title="<?=htmlspecialchars($item['image_title'])?>" id="image_file" style="cursor: pointer;">
									<script>
										$("#image_file").click(function() {
												var base_url = "<?=$this->config->item('base_url')?>files/counties/";
					...
					<div class="clear"></div>
					<a href="<?=base_url(array("admin.php", "counties"));?>" class="btn btn-outline btn-primary">Înapoi</a>
